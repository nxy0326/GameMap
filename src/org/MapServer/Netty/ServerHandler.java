...
//        ByteBuf sb = (ByteBuf) fullHR.content();
        ...
        System.out.println(url + ":=============================================");
            ...
            if (url.equals("/")) {//首次访问返回首页
                try {
                    FileInputStream fin = new FileInputStream("F:\\MyGameMap\\web\\Find_Road\\login.html");
...
//                    System.out.println("===========================================" + mess);
            ...
            if (url.equals("/register.html")){//处理注册页面
                try {
                    FileInputStream fin = new FileInputStream("F:\\MyGameMap\\web\\Find_Road\\register.html");
                    FileChannel fc = fin.getChannel();
...
//                    System.out.println("===========================================" + mess);
            ...
            if (url.equals("/search.html")){//搜索页面
                ...
                try {
                    FileInputStream fin = new FileInputStream("F:\\MyGameMap\\web\\Find_Road\\search.html");
                    FileChannel fc = fin.getChannel();
                    ByteBuffer bf = ByteBuffer.allocate(2048);
                    String mess = "";
                    while ((fc.read(bf)) != -1) {
...
//                    System.out.println("===========================================" + mess);
            ...
            if (url.equals("/choose.html")){//选择模式页面
                try {
                    FileInputStream fin = new FileInputStream("F:\\MyGameMap\\web\\Find_Road\\choose.html");
                    FileChannel fc = fin.getChannel();
                    ByteBuffer bf = ByteBuffer.allocate(2048);
                    String mess = "";
                    while ((fc.read(bf)) != -1) {
...
//                    System.out.println("===========================================" + mess);
            ...
            if (url.equals("/nvip")){//普通用户登录
                ...
                FileInputStream fin = new FileInputStream("F:\\MyGameMap\\web\\Find_Road\\assets\\bg1.jpg");
